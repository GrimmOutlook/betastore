...
class PasswordResetsControllerTest < ActionController::TestCase
  ...
  test "edit with valid id and valid token" do
    #assert customer(:test).authenticate('password')
